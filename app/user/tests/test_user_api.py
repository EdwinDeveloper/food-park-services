...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short(self):
        """Test password mush be more than 5 characters"""
        payload = {
            'email': 'edwindeveloper@outlook.com',
            'password': 'sd'
        }
    ...
    def test_create_token_for_user(self):
        """Test that token is created by user"""
        payload = {'email': 'edwindeveloper@outlook.com',
                   'password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='edwindeveloper@outlook.com',
                    password='password')
        payload = {'email': 'edwindeveloper@outlook.com',
                   'password': 'wrong pass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_no_user(self):
        ...
        payload = {'edwin': 'edwindeveloper@outlook.com',
                   'password': 'testpass'}
        res = self.client.post(TOKEN_URL, payload)
...
class PrivateUserApiTest(TestCase):
    """Test API request that requiere authenticacion"""
    def setUp(self):
