...
class Service(models.Model):
    ...
    #Relations
    pet = models.ForeignKey(Pet, related_name="services", on_delete=models.CASCADE)
...
class Property(models.Model):
    ...
    #Relations
    estate = models.ForeignKey(Estate, related_name="properties", on_delete=models.CASCADE)
...
class Pay(models.Model):
    ...
    #Relations
    property = models.ForeignKey(Property, related_name="pays",  blank=True, null=True, on_delete=models.CASCADE)
...
class Contract(models.Model):
    ...
    DEPARTAMENTO = models.ForeignKey(Property, related_name="contracts",  blank=True, null=True, on_delete=models.CASCADE)
